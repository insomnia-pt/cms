		...
		return {
			...
			contents: [ {
				...
				},
				{
					...
					setup: function( data ) {
						//INSOMNIA - MIGUEL PEREIRA - FIX ACCORDION PLUGIN
						var accordion = null;
						if(data.hasOwnProperty('advanced')){
							accordion = (data.advanced.advCSSClasses=='accordion-section-name')?'accordion':null;
						} 
						this.setValue(accordion || data.type || 'url' );
						//////
					},
					commit: function( data ) {
